...
assess_accessibility <- function(grid_number,grids,produce_map = F){
  ...
  if(produce_map){
    ...
    #save
    saveWidget(m, file="../maps/access_map_grid.html",title =  paste0("Grid: ",grid_number))
    ...
    file.rename(from = "../maps/access_map_grid.html", to = paste0("../maps/access_map_grid_",grid_number,".html"))
    #return(m)
  }
...
saveWidget(m, file="../maps/access_map_grid_master.html",title = "Master grid map")
